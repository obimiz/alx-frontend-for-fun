...
ext/zlib/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --extstatic $(EXTSTATIC) \
		-- configure $(@D)
gems: gems/did_you_mean-1.2.0/exts.mk
gems/did_you_mean-1.2.0/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
gems: gems/minitest-5.10.3/exts.mk
gems/minitest-5.10.3/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
gems: gems/net-telnet-0.1.1/exts.mk
gems/net-telnet-0.1.1/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
gems: gems/power_assert-1.1.1/exts.mk
gems/power_assert-1.1.1/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
gems: gems/rake-12.3.3/exts.mk
gems/rake-12.3.3/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
gems: gems/test-unit-3.2.7/exts.mk
gems/test-unit-3.2.7/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
